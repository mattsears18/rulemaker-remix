...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create rulemaker-remix-81ad
  fly apps create rulemaker-remix-81ad-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app rulemaker-remix-81ad
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app rulemaker-remix-81ad-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'rulemaker-remix-81ad-staging' does not match app name in config file 'rulemaker-remix-81ad'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name rulemaker-remix-81ad-db
  fly postgres attach --app rulemaker-remix-81ad rulemaker-remix-81ad-db

  fly postgres create --name rulemaker-remix-81ad-staging-db
  fly postgres attach --app rulemaker-remix-81ad-staging rulemaker-remix-81ad-staging-db
  ```
